...
import dev.inkwell.vivid.widgets.value.EnumSelectorComponent;
import dev.inkwell.vivid.widgets.value.ToggleComponent;
import dev.inkwell.vivid.widgets.value.entry.FloatEntryWidget;
import dev.inkwell.vivid.widgets.value.entry.IntegerEntryWidget;
